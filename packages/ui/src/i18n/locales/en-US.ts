...
const enUS: Record<string, string> = {
  ...
  "settings.themeModeDescription": "Choose light, dark, sakura pink, DeepSeek blue, starry night, dusk gold, blossom pink, forest green, or follow the system theme.",
  "settings.appearance.wallpaper": "Conversation background",
  "settings.appearance.wallpaperDescription": "Customize the conversation-area wallpaper of the sakura theme (png/jpg/webp up to 20MB); falls back to the built-in image when unset.",
  "settings.appearance.wallpaperChoose": "Choose image…",
  "settings.appearance.wallpaperReset": "Reset",
  "settings.appearance.wallpaperCustom": "Custom",
  "settings.appearance.wallpaperDefault": "Default",
  "settings.appearance.wallpaperTooLarge": "Image exceeds 20MB, pick another one",
  ...
  "settings.themeMode.sakura": "Sakura pink",
  "settings.themeMode.deepseek": "DeepSeek blue",
  "settings.themeMode.starrynight": "Starry night",
  "settings.themeMode.duskglow": "Dusk gold",
  "settings.themeMode.blossom": "Blossom pink",
  "settings.themeMode.forest": "Forest green",
