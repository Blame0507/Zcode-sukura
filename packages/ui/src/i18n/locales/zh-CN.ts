...
const zhCN: Record<string, string> = {
  ...
  "settings.themeModeDescription": "选择浅色、深色、樱花粉、深海蓝、星夜、暮金、樱粉、森绿或跟随系统主题。",
  "settings.appearance.wallpaper": "对话区背景图",
  "settings.appearance.wallpaperDescription": "自定义樱花主题对话区的背景图片(支持 png/jpg/webp,20MB 以内);不设置时使用内置默认壁纸。",
  "settings.appearance.wallpaperChoose": "选择图片…",
  "settings.appearance.wallpaperReset": "恢复默认",
  "settings.appearance.wallpaperCustom": "已自定义",
  "settings.appearance.wallpaperDefault": "默认壁纸",
  "settings.appearance.wallpaperTooLarge": "图片超过 20MB,请换一张",
  ...
  "settings.themeMode.sakura": "樱花粉",
  "settings.themeMode.deepseek": "深海蓝(DeepSeek)",
  "settings.themeMode.starrynight": "星夜",
  "settings.themeMode.duskglow": "暮金",
  "settings.themeMode.blossom": "樱粉",
  "settings.themeMode.forest": "森绿",
