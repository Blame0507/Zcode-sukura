...
export const DesktopCommandIds = {
  ...
  ChooseConversationWallpaper: "chooseConversationWallpaper",
  ClearConversationWallpaper: "clearConversationWallpaper",
  GetConversationWallpaper: "getConversationWallpaper",
} as const;
